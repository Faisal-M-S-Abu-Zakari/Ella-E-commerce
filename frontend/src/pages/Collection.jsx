  ...
  return (
    <div className="flex sm:flex-row flex-col gap-1 sm:gap-10 pt-10 border-t">
      ...
      <div className="min-w-60">
        ...
        <div
          className={`border border-border px-5 py-3 mt-6 ${
            showFilter ? "" : "hidden"
          } sm:block`}
        >
          <p className="mb-3 font-medium text-sm">CATEGOTY</p>
        ...
        {/* SubCategory Filter */}
        <div
          className={`border border-border px-5 py-3 my-5 ${
            showFilter ? "" : "hidden"
          } sm:block`}
        >
      ...
      <div className="flex-1">
        ...
        {/* Map Products */}
        <div className="gap-4 gap-y-6 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4">
