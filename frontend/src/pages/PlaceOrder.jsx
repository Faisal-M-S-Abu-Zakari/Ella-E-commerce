        ...
        <div className="mt-12">
          ...
          <div className="flex lg:flex-row flex-col gap-3">
            ...
            <div
              onClick={() => {
                setMethod("paypal");
                toast.info("PayPal payment gateway will be available soon!");
              }}
              className="flex items-center gap-3 p-2 px-3 border cursor-pointer"
            >
              <p
              ...
              ></p>
              <img className="mx-4 h-5" src={assets.Paypal} alt="" />
            </div>
            <div
          ...
          <div className="mt-8 w-full text-end">
            <button
              type="submit"
              className="bg-primary px-16 py-3 text-white text-sm"
            >
              PLACE ORDER
            </button>
          </div>
